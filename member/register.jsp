    ...
    <div class="container">
        ...
        <div class="col-lg-6">
            <div class="jumbotron" id="register_jumbo">
                ...
                <hr>
                <form action="registerService.jsp">
                    <label>아이디</label>
                    ...
                    <label>이메일</label>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="이메일" name="pwConfirm" maxlength="15">
                    </div>
                    <label>전화번호</label>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="전화번호" name="pwConfirm" maxlength="15">
                    </div>
                    <label></label>
